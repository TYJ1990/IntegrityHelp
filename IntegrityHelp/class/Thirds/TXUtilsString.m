...
{
//    CGFloat autoheight;
//    autoheight =[string boundingRectWithSize:Size options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:font] } context:nil].size.height;
    NSDictionary *dic = @{NSFontAttributeName: [UIFont systemFontOfSize:font]};
    CGFloat autoheight = [string boundingRectWithSize:Size options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size.height;
    return autoheight;
}
/*
 计算字符串宽度
