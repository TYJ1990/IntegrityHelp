...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    CGRect targetTemp = CGRectMake(currentIndex * 85 + 107, self.sourceImagesContainerView.frame.origin.y + 60 + self.offHeight, 80, 60);
...
//    CGRect rect = [self.sourceImagesContainerView convertRect:sourceView.frame toView:self];
    CGRect rect = CGRectMake(self.currentImageIndex * 85 + 107, self.sourceImagesContainerView.frame.origin.y + 60 + self.offHeight, 80, 60);
