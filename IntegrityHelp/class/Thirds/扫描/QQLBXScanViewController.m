...
- (void)drawBottomItems
{
    ...
    _btnFlash.center = CGPointMake(CGRectGetWidth(_bottomItemsView.frame)/2 + 50, CGRectGetHeight(_bottomItemsView.frame)/2);
    ...
    _btnPhoto.center = CGPointMake(CGRectGetWidth(_bottomItemsView.frame)/2 - 50, CGRectGetHeight(_bottomItemsView.frame)/2);
...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    ...
    _callBack(strResult.strScanned);
}
